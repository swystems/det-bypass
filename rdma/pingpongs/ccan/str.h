 ...
 */
static inline bool
strends (const char *str, const char *postfix)
{
 ...
 */
size_t
strcount (const char *haystack, const char *needle);
...
#define str_check_arg_(i) \
    ((i) + BUILD_ASSERT_OR_ZERO (!__builtin_types_compatible_p (typeof (i), char) || (char) 255 > 0))
#else
